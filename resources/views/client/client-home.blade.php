                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 apply">
                            <div class="row">
                                <div class="col-md-12 apply">
                                    <a href="#" class="btn btn-outline-primary btn-round btn-lg btn-block p-1 mb-2">Browse
                                        Available Jobs</a>
                                </div>
                        ...
                        <div class="col-md-6 apply float-right">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" class="btn btn-outline-success btn-round btn-lg btn-block p-1 mb-2">Apply
                                        A Job</a>
                                </div>
                                <div class="col-md-12">
                                    <a href="{{route('c-profile-preview')}}" class="btn btn-outline-primary btn-round btn-lg btn-block p-1 mb-2" data-id ={{Auth::user()->id}}<i
                    ...
                    <div class="card card-outline-primary mt-5">
                        <div class="card-header bg-info">
                            <div class="card-title">
                                <h4 style="color: white" class="text-center"> <i class="feather icon-briefcase"></i> Recommended Jobs</h4>
                            </div>
                        </div>
                        <div class="card-body">
