                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-12" id="customDiv">
                                                        <form class=" form customForm" action="" method="POST"
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="your-action-url" method="POST" name="prevHistory" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="school" name="school" placeholder="enter your skills here">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="program"
                                                    name="program">
                                            </div>
                                        </div>
                                    </div>
