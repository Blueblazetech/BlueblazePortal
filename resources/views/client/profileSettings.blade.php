                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date" class="form-control"
                                                                                id="dob" value="" required name="dob">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" class="form-control"
                                                                                id="mail" value="" required name="mail">
                                                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-grd-primary float-right btn-round"
                                                    ...
                                                    <div class="col-md-6">
                                                        <h4>Employment Vacancies</h5>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="radio" id="unavailable" name="unavailable">
                                                            </div>
                                                    </div>
                                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <input type="file" class="form-control" id="schoolFile" name="schoolFile">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id="editSkills" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">Skills Section</div>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form action="" method="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="school" name="school"
