                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="">
                                <a href="{{asset('assets\extra-pages\landingpage\index.htm')}}" target="_blank">
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{asset('assets\extra-pages\email-templates\email-welcome.htm')}}">
                                                    <span class="pcoded-mtext">Welcome Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{asset('assets\extra-pages\email-templates\email-password.htm')}}">
                                                    <span class="pcoded-mtext">Reset Password</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{asset('assets\extra-pages\email-templates\email-newsletter.htm')}}">
                                                    <span class="pcoded-mtext">Newsletter Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{asset('assets\extra-pages\email-templates\email-launch.htm')}}">
                                                    <span class="pcoded-mtext">App Launch</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{asset('assets\extra-pages\email-templates\email-activation.htm')}}">
                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    <div class="col-sm-3 m-b-30">
                                                        <a href="{{asset('assets\extra-pages\404\2\index.htm')}}" target="_blank"><img src="{{asset('assets\images\error\error-1.jpg')}}" alt="Layout-1" class="img-fluid img-thumbnail"></a>
                                                    </div>
                                            </div>
                                        </div>
