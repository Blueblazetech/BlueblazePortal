...
@section('title', 'cancelled-applications')
@section('page-css')
<!--chartlist-->
...
@section('content')
                ...
                <div class="col">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">cancelled</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-block-big">
                <div id="monthly-graph" style="height: 400px"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="card z-depth-1">
            ...
            <div class="card-body">
                <livewire:applications.cancelled-application/>
            </div>
